...
import input_module_dynatrace_timeseries_metrics as input_module
...
'''
    ...
    Add your modular input logic to file input_module_dynatrace_timeseries_metrics.py
'''
class ModInputdynatrace_timeseries_metrics(modinput_wrapper.base_modinput.BaseModInput):
