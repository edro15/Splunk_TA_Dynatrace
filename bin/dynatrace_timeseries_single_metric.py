...
import input_module_dynatrace_timeseries_single_metric as input_module
...
'''
    ...
    Add your modular input logic to file input_module_dynatrace_timeseries_single_metric.py
'''
class ModInputdynatrace_timeseries_single_metric(modinput_wrapper.base_modinput.BaseModInput):
