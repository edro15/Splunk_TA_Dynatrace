...
import input_module_dynatrace_entity_by_management_zone as input_module
...
'''
    ...
    Add your modular input logic to file input_module_dynatrace_entity_by_management_zone.py
'''
class ModInputdynatrace_entity_by_management_zone(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputdynatrace_entity_by_management_zone, self).__init__("splunk_ta_dynatrace", "dynatrace_entity_by_management_zone", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputdynatrace_entity_by_management_zone, self).get_scheme()
        scheme.title = ("Dynatrace Entity by Management Zone")
        ...
        scheme.add_argument(smi.Argument("entity_endpoints", title="Entity Endpoints",
                                         ...
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("management_zones", title="Management Zones",
                                         description="Comma delimited list of management zone IDs",
                                         required_on_create=True,
                                         required_on_edit=False))
...
if __name__ == "__main__":
    exitcode = ModInputdynatrace_entity_by_management_zone().run(sys.argv)
    sys.exit(exitcode)
