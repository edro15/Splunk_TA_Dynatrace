...
def collect_events(helper, ew):
    ...
    opt_dynatrace_management_zones = helper.get_arg('management_zones').split(",")
    ...
    for endpoint in opt_dynatrace_entity_endpoints:
        ...
        for mz in opt_dynatrace_management_zones:
            response = helper.send_http_request(api_url + endpoint + "?managementZone=" + mz , "GET", headers=headers,  parameters=parameters, payload=None, cookies=None, verify=verify_ssl, cert=None, timeout=None, use_proxy=True)
