...
import input_module_dynatrace_problem as input_module
...
'''
    ...
    Add your modular input logic to file input_module_dynatrace_problem.py
'''
class ModInputdynatrace_problem(modinput_wrapper.base_modinput.BaseModInput):
